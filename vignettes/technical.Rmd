...
\begin{equation*}
  \begin{split}
  \text{Cov}(\hat{\boldsymbol{\Sigma}}^{-1/2} \mathbf{e}_{r}) & \approx \boldsymbol{\Sigma}^{-1/2} \text{Cov}(\mathbf{e}_{r}) (\boldsymbol{\Sigma}^{-1/2})^\top \\
  & \approx \boldsymbol{\Sigma}^{-1/2} \boldsymbol{\Sigma} (\boldsymbol{\Sigma}^{-1/2})^\top \\
  & = \boldsymbol{\Sigma}^{-1/2} \boldsymbol{\Sigma}^{1/2} (\boldsymbol{\Sigma}^{1/2})^\top (\boldsymbol{\Sigma}^{-1/2})^\top \\
  & = (\mathbf{I}) (\mathbf{I}) \\
  & = \mathbf{I}
  \end{split}
\end{equation*}
