...
explores tools for predicting the average value of a response variable in a particular geographic region, an approach known as Block Prediction (i.e., Block Kriging) [@cressie1993statistics; @ver2008spatial]. Full technical details are provided in the [Block Prediction](https://usepa.github.io/spmodel/articles/technical.html#sec:predict-block-lm) section of the Technical Details vignette. Before proceeding, we
