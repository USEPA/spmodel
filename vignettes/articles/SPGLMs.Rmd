...
statistics such as AIC [@akaike1974new; @hoeting2006model] are defined,
...
least squares). @ver2023marginal provide the methodology's full details.
...
statistics like AIC, AICc, and deviance [@mccullagh1989generalized],
...
the two strata (all $p~$values $<$ 0.05). The \texttt{plot()} function
