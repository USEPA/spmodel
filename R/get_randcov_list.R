...
# get_randcov_list functions have been deprecated post spmodel v0.5.1
...
get_randcov_Z <- function(randcov_name, data, ZZt = TRUE, ZtZ = FALSE, xlev_list = NULL) {
  ...
  # as of 2-2024 this has been omitted as it interferes with the new version of local
  # random effect efficiency AND the BLUPs for levels not in the observed data are constrained to be zero
  # so it is not necessary anyway
...
# get randcov xlevels to put in indexes
